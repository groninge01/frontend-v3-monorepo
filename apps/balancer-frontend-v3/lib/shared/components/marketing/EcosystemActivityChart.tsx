...
import ButtonGroup from '@frontend-monorepo/balancer-frontend-v3/lib/shared/components/btns/button-group/ButtonGroup'
...
} from '@frontend-monorepo/balancer-frontend-v3/lib/modules/marketing/useEcosystemPoolActivity'
