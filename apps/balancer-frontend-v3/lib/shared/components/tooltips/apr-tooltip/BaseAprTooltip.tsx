...
} from '@frontend-monorepo/balancer-frontend-v3/lib/shared/hooks/useAprTooltip'
...
import { isVebalPool } from '@frontend-monorepo/balancer-frontend-v3/lib/modules/pool/pool.helpers'
