...
} from '@frontend-monorepo/balancer-frontend-v3/test/msw/handlers/Pool.handlers'
...
import { defaultTestGaugeAddress } from '@frontend-monorepo/balancer-frontend-v3/test/msw/builders/gqlStaking.builders'
