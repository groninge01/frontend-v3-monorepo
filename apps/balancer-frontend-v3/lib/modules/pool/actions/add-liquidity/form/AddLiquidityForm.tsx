...
import {
  ...
  useTokenBalances,
} from '@frontend-monorepo/balancer-frontend-v3/lib/modules/tokens/TokenBalancesProvider'
import {
  Box,
  Button,
  Card,
...
import AddLiquidityAprTooltip from '@frontend-monorepo/balancer-frontend-v3/lib/shared/components/tooltips/apr-tooltip/AddLiquidityAprTooltip'
import { calcPotentialYieldFor } from '../../../pool.utils'
import { cannotCalculatePriceImpactError } from '@frontend-monorepo/balancer-frontend-v3/lib/modules/price-impact/price-impact.utils'
