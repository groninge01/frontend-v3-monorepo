import { testAccountIndex } from '@frontend-monorepo/balancer-frontend-v3/test/anvil/anvil-setup'
import {
  addTestUserAddress,
  testWagmiConfig,
} from '@frontend-monorepo/balancer-frontend-v3/test/anvil/testWagmiConfig'
