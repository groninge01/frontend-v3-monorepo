        ...
        <div className="pb-4">
            ...
            <div className="subsection">
              ...
              <p>
                <em className="font-medium">
                  This Privacy Policy explains how the Balancer Foundation, its subsidiary, Balancer
                  OpCo Limited (“Balancer Foundation,” “Balancer,” “we,” “our,” or “us”) collects,
                  uses, and discloses information about you. This Privacy Policy applies when you
                  use our website, Balancer Protocol user-interface or application and other online
                  products (collectively, our “UI”), engage with us on social media, or otherwise
                  interact with us.
                </em>
              </p>
              <p>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <ul>
                <li>
                  Balancer does not typically request, collect or use personal information. With the
                  exception of your wallet address, there is no reason for you to provide personal
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                providers. Your wallet and IP address is accessible to Balancer and its vendor(s).
                We may make inferences about you based on your wallet or IP address.
              </p>
            </div>
          </FadeInOnView>
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                the UI for your use. However, we reserve the ability to use information we collect
                to provide, maintain, administer and/or improve the UI. We may also use the
              ...
              <ul>
                ...
                <li>
                  For other reasonable internal use or uses aligned with your relationship with us
                  and the context in which we collected the information.
                </li>
              </ul>
            </div>
          </FadeInOnView>
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                described herein, in the normal course of Balancer business. However, when Balancer
                has access to personal information, such as your wallet and certain IP addresses, it
                may share that information in the following circumstances or as otherwise described
                in this policy:
              </p>
              <ul>
                <li>
                ...
                <li>
                  ...
                  lawful requests by public authorities to meet national security or law enforcement
                  requirements.
                </li>
                <li>
                  We may share personal information if we believe that your actions are inconsistent
                  with our user agreements or policies, if we believe that you have violated the
                  law, or if we believe it is necessary to protect the rights, property, and safety
                  of Balancer, the Balancer ecosystem, the public, or others.
                </li>
                <li>
                ...
                <li>
                  ...
                  concerning, merger, sale of company assets, financing, bankruptcy, business
                  closure, or acquisition of all or a portion of our assets. Additionally, as part
                  of such an event, we may transfer or sell personal information to a third party.
                ...
                <li>
                  Personal information may be shared between and among Balancer and our current and
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                Balancer Foundation is headquartered in the Cayman Islands with a subsidiary in the
                British Virgin Islands (BVI). Therefore, we and our service providers may transfer
                your personal information to, or store or access it in, jurisdictions that may not
                provide levels of data protection that are equivalent to those of your home
                jurisdiction. We will take steps to ensure that your personal information receives
                an adequate level of protection in the jurisdictions in which we process it.
              </p>
            </div>
          </FadeInOnView>
          <FadeInOnView>
            <div className="subsection">
              ...
              <h3>Cookies</h3>
              <p>
                Balancer and its third party vendors may use any cookies to affect the availability
                and functionality of the UI. For more information about cookies and how to disable
                them, see our <Link href="cookies-policy">Cookies policy</Link>.
              </p>
            </div>
          </FadeInOnView>
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                ...
                described in the Use of Information section above. In the preceding 12 months, we
                have disclosed the following categories of personal information for business
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    <p>
                      We share with vendors, such CloudFlare and Fathom Analytics: certain IP
                      addresses, device identifiers or other similar identifiers.
                    </p>
              ...
              <p>
                Balancer does not “sell” personal information to advertise our products to you or
                otherwise.
              </p>
              ...
              <p>
                ...
                has valid written authority to submit requests to exercise rights on your behalf. If
              ...
              <p>
                Balancer does not share such information with third parties for direct marketing
                purposes.
              </p>
              ...
              <p>
                ...
                <a className="link" target="_blank" href="https://allaboutdnt.com/">
                  www.allaboutdnt.com
                </a>
                .
              </p>
          ...
          <FadeInOnView>
            <div className="subsection">
              ...
              <p>
                Balancer does not typically process user personal data. If Balancer processes data,
                such as a wallet address and certain IP addresses, it will do so in reliance on the
                following lawful bases:
              </p>
              <ul>
                <li>
                  To perform our responsibilities under our contract with you (e.g., providing
                  access to the UI you requested).
                </li>
                <li>
              ...
              <p>
                ...
                ask that your personal data be corrected or erased, and the right to object to, or
                request that we restrict, certain processing. Balancer does not typically hold or
